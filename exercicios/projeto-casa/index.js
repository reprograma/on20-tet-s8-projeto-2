...
// Ao clicar no botão, checa se ta com o texto Marcar todas. 
//Se tiver, adiciona a classe checked pra todas e muda o nome para Desmarcar todas
    if (botaoMarcarTodos.innerText === "Marcar todas") {
        ...
        // Ao clicar no botão, Checa se o botao ta Desmarcar todas.
        // Se tiver, tira a classe checked pra todas e muda o nome para Marcar todas
    } else {
        itensDaListaDeTarefas.forEach(function (li) {
