...
function cadastrarTarefa(evento) {
    ...
    if (inputTarefa.value.trim() === '') {
        mensagemErro.innerHTML = ' O campo não pode esta vazio';
    }
...
// Ana só consegui fazer até a menssagem de erro, infelizmente não consegui concluir o resto mais eu tentei
